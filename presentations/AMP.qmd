...
```{r}
EX_1 <- read.csv("https://raw.githubusercontent.com/amromeo/ramp24/blob/main/presentations/Accuracy%20-%20Exercise.csv", header = TRUE)
head(EX_1)
```
...
```{r}
EX_2 <- read.csv("https://raw.githubusercontent.com/amromeo/ramp24/blob/main/presentations/ROC%20Data%20-%20Exercise.csv", header = TRUE)
head(EX_2)
```
...
```{r}
EX_3 <- read.csv("https://raw.githubusercontent.com/amromeo/ramp24/blob/main/presentations/Correlation%20Data%20-%20Exercise.csv", header = TRUE)
head(EX_3)
```
