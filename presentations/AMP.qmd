...
EGFR <- read.csv("C:/Users/amirm/OneDrive/Papers/AMP course/Accuracy Data.csv", header = TRUE) #the read.csv() function requires the address of the .csv file as it's first input. header (TRUE or FALSE) determines whether the columns have a header. ## <- use the arrow to assign a value to a variable. Here the variable is a table called EGFR.
...
```{r}
DDPCR=read.csv("C:/Users/amirm/OneDrive/Papers/AMP course/ROC Data.csv", header = TRUE)
...
```{r}
QPCR=read.csv("C:/Users/amirm/OneDrive/Papers/AMP course/Quantitative Data2.csv", header = TRUE)
...
```{r}
EX_1 <- read.csv("C:/Users/amirm/OneDrive/Papers/AMP course/Accuracy - Exercise.csv", header = TRUE)
head(EX_1)
```
...
```{r}
EX_2 <- read.csv("C:/Users/amirm/OneDrive/Papers/AMP course/ROC Data - Exercise.csv", header = TRUE)
head(EX_2)
```
...
```{r}
EX_3 <- read.csv("C:/Users/amirm/OneDrive/Papers/AMP course/Correlation - Exercise.csv", header = TRUE)
head(EX_3)
```
